<?php
  namespace Kps3\Framework\Controllers {
    ...
    use Kps3\Framework\Presenters\PresentableInterface;
    use Kps3\Framework\Presenters\PresentableTrait;

    /**
     * Sets up the basic most methods used by all of the controllers.
     */
    abstract class BaseViewController extends BaseController implements PresentableInterface {

      use PresentableTrait;

      protected $presenter = '\Kps3\Framework\Presenters\DefaultControllerPresenter';
