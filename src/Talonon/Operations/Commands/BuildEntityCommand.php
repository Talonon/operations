<?php
  ...
  namespace Talonon\Operations\Commands {

    use Illuminate\Console\Command;
    use Illuminate\Database\Connection;
    use Illuminate\Support\Pluralizer;
    use Illuminate\Support\Str;
    use Talonon\Operations\Builder\BaseBuilder;
    use Talonon\Operations\Builder\CreateOperationBuilder;
    use Talonon\Operations\Builder\DeleteOperationBuilder;
    use Talonon\Operations\Builder\EntityBuilder;
    use Talonon\Operations\Builder\GetListOperationBuilder;
    use Talonon\Operations\Builder\GetOperationBuilder;
    use Talonon\Operations\Builder\MapperBuilder;
    use Talonon\Operations\Builder\SearchParamsBuilder;
    use Talonon\Operations\Builder\SoftDeleteOperationBuilder;
    use Talonon\Operations\Builder\UpdateOperationBuilder;
    use Talonon\Operations\Builder\CreateTraitBuilder;
    use Talonon\Operations\Builder\DeleteTraitBuilder;
    use Talonon\Operations\Builder\GetListTraitBuilder;
    use Talonon\Operations\Builder\GetTraitBuilder;
    use Talonon\Operations\Builder\SoftDeleteTraitBuilder;
    use Talonon\Operations\Builder\UpdateTraitBuilder;
    ...
    class BuildEntityCommand extends Command {
       ...
       * @var string
       */
      protected $description = 'Build\'s a KPS3-Operations model/mapper/create/update/delete/softdelete/get/getlist operations and traits.';
